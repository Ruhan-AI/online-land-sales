...
export function PropertyGrid({ properties, onResetFilters }: PropertyGridProps) {
  ...
  return (
    <div className="space-y-6">
      {/* Controls Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-4 rounded-2xl border border-brand-border shadow-soft">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 text-xs">
            ...
            <select
              ...
              className="bg-brand-sand-light border border-brand-border rounded-xl px-3 py-2 text-xs font-semibold text-brand-ink focus:outline-none focus:ring-2 focus:ring-brand-blue"
            >
          ...
          {/* View Mode Toggle */}
          <div className="flex items-center p-1 bg-brand-sand rounded-xl border border-brand-border">
            <button
      ...
      {sortedProperties.length === 0 ? (
        <div className="bg-white border border-brand-border rounded-card p-12 text-center space-y-4 shadow-soft">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          {/* List Column */}
          <div className="lg:col-span-6 space-y-4 max-h-[900px] overflow-y-auto pr-2">
            {sortedProperties.map((property) => (
              <div
                key={property.id}
          ...
          {/* Map Column */}
          <div className="lg:col-span-6 sticky top-28 h-[800px] rounded-card overflow-hidden">
            <PropertyMap
        ...
        // Full Map View
        <div className="h-[750px] rounded-card overflow-hidden">
          <PropertyMap
            properties={sortedProperties}
            selectedPropertyId={selectedPropertyId}
            onSelectProperty={(prop) => setSelectedPropertyId(prop.id)}
