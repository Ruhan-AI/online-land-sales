...
export function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
      ...
      <div
        className={cn(
          "relative w-full bg-white rounded-modal shadow-2xl border border-brand-border z-10 overflow-hidden my-auto animate-in fade-in zoom-in-95 duration-200",
          maxWidthClasses[maxWidth]
        )}
      >
        {(title || subtitle) && (
          <div className="flex items-start justify-between p-5 sm:p-6 border-b border-brand-border bg-brand-sand-light/50">
            <div>
