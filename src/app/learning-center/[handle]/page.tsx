  ...
  return (
    <div className="bg-brand-canvas min-h-screen py-8 sm:py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-10 border border-brand-border shadow-soft prose prose-slate max-w-none text-slate-700 leading-relaxed text-sm sm:text-base space-y-6">
        ...
        <div className="bg-gradient-to-br from-brand-ink to-brand-charcoal text-white rounded-3xl p-8 sm:p-10 shadow-2xl border border-white/10 text-center space-y-4">
          <h3 className="text-2xl font-bold">Ready to Start Your Land Journey?</h3>
